...
RSpec.describe "Posts", type: :request do
  ...
  describe "POST /posts" do
    ...
    context "with valid params" do
      ...
      before do
        ...
        post "/post", params: post_attributes, headers: { Authorization: "Bearer #{token}" }
      end
    ...
    context "with invalid params" do
      ...
      it "returns a respons with errors" do
  ...
  describe "PUT /posts/:id" do
    context "with valid params" do
      ...
      let(:token) { auth_token_for_user(user)}
      before do
        post_attributes = attributes_for(:post, content: "new content")
